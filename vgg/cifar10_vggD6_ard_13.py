...
FLAGS.save_name='cifar10_vggD6_ard_13'
...
class VGGD6_CIFAR10(torch.nn.Module):
    def __init__(self):
        super(VGGD6_CIFAR10, self).__init__()        
        convs=make_conv_layers(D6config)
        self.convs=torch.nn.Sequential(*convs)
        fcs = [ARDDense(512, 512,FLAGS.init_alpha), torch.nn.ReLU(),
               ARDDense(512, 10,FLAGS.init_alpha)]
...
for aziter in range(azstart,FLAGS.azepoch):
    ...
    if aziter==0:
        resumefile='cifar10_vggD6_map_alpha0-statedict.ckpt'
